...
bot.onText(/\/start/, (msg) => {
  ...
  bot.sendMessage(chatId, 'Welcome to your Telegram bot!').catch(error => {
...
bot.onText(/\/help/, (msg) => {
  ...
  bot.sendMessage(chatId, 'How can I assist you?').catch(error => {
...
bot.on('message', (msg) => {
  ...
  if (msg.text && !msg.text.startsWith('/')) {
    bot.sendMessage(chatId, `You said: ${msg.text}`).catch(error => {
